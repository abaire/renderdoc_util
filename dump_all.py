...
def _dump_outputs(action, pipeline, output_path):
        ...
        def save(resource_id, filename, alpha=renderdoc.AlphaMapping.Preserve):
                ...
                replay_manager.BlockInvoke(lambda controller: controller.SaveTexture(texsave, filename + ".png"))
        ...
        for index, resource in enumerate(draw_fbo.colorAttachments):
                ...
                save(resource_id, f"EID_{action.eventId}_color_{index}-{resource_id}", renderdoc.AlphaMapping.Discard)
